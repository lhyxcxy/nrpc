...
public class RpcClassPathBeanDefinitionScanner extends ClassPathBeanDefinitionScanner {
	...
	protected static Set<BeanDefinitionHolder> serviceBeanDefinitionHolders=new HashSet<>();
    ...
    public Set<BeanDefinitionHolder> doScan(String... basePackages) {
    	Set<BeanDefinitionHolder>bdhSet=super.doScan(basePackages);
    	serviceBeanDefinitionHolders.addAll(bdhSet);
        return bdhSet;
    }
